...
public class SellerController {
	...
	@PostMapping("/login")
	public <LoginDTO> ResponseEntity<String> loginSeller(@RequestBody LoginDTO loginDTO) {
		SellerController sellerService = null;
		String token = String.valueOf(sellerService.loginSeller(loginDTO));
